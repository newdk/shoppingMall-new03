...
<script type="text/javascript">
	$(document).ready(function(){
		...
		location.href = "${path }/qna/readView?bno=${update.bno}"
			   + "&page=${scri.page}"
		...
		$(".update_btn").on("click", function(){
			...
			formObj.attr("action", "${path }/qna/update.do");
...
<form name="updateForm" role="form" method="post" action="${path }/qna/update.do" enctype="multipart/form-data">
